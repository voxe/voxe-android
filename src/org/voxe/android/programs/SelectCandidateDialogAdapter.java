...
public class SelectCandidateDialogAdapter extends BaseAdapter {
	...
	public SelectCandidateDialogAdapter(Context context, List<SelectedCandidate> candidates) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView != null) {
			...
			ViewGroup viewGroup = (ViewGroup) View.inflate(context, R.layout.select_candidate_dialog_grid_item, null);
	...
	public void updateSelectedCandidates(List<SelectedCandidate> candidates) {
		this.candidates = candidates;
		notifyDataSetChanged();
	}
	
	public List<SelectedCandidate> getSelectedCandidates() {
		return candidates;
	}
